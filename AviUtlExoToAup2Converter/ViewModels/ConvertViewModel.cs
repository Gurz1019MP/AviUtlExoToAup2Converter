...
namespace AviUtlExoToAup2Converter.ViewModels
{
    public class ConvertViewModel : ViewModel
    {
        ...
        public ConvertViewModel(Models.Convert model)
        {
            _model = model;
        ...
        private ViewModelCommand? _InvokeCommand;

        public ViewModelCommand? InvokeCommand
        {
            get
            {
                if (_InvokeCommand == null)
                {
                    _InvokeCommand = new ViewModelCommand(Invoke, CanInvoke);
                }
        ...
        private readonly Models.Convert _model;
